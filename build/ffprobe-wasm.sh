...
# ex:
#     bash ffprobe-wasm.sh -o ffprobe.js
...
CONF_FLAGS=(
  ...
  -sEXPORTED_FUNCTIONS=$(node src/bind/ffprobe/export.js) # exported functions
  -sEXPORTED_RUNTIME_METHODS=$(node src/bind/ffprobe/export-runtime.js) # exported built-in functions
  -lworkerfs.js
  --pre-js src/bind/ffprobe/bind.js        # extra bindings, contains most of the ffprobe.wasm javascript code
  # ffprobe source code
