...
/**
 * In multithread version of ffprobe.wasm, the bootstrap process is like:
 * 1. Execute ffprobe-core.js
 * 2. ffprobe-core.js spawns workers by calling `new Worker("ffprobe-core.worker.js")`
 * 3. ffprobe-core.worker.js imports ffprobe-core.js
 * 4. ffprobe-core.js imports ffprobe-core.wasm
 *
 ...
 * there is no way to pass custom ffprobe-core.wasm URL to ffprobe-core.worker.js
 * when it imports ffprobe-core.js in #3.
 *
 ...
 *
 *   http://example.com/ffprobe-core.js#{btoa(JSON.stringify({"wasmURL": "...", "workerURL": "..."}))}
 *
